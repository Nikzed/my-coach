...
--
-- Class CoachMessage as table coach_message
--
...
--
-- Class Subtask as table subtask
--
...
--
-- Class TaskReminder as table task_reminder
--
...
--
-- Class VoiceTaskDraft as table voice_task_draft
--
...
--
-- Foreign relations for "coach_message" table
--
...
--
-- Foreign relations for "subtask" table
--
...
--
-- Foreign relations for "task_reminder" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('my_coach_serverpod_challenge', '20260125214828049', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260125214828049', "timestamp" = now();
